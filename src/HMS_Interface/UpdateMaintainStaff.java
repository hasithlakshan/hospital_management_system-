...
public class UpdateMaintainStaff extends javax.swing.JFrame {
    ...
    public UpdateMaintainStaff() {
     ...
     void setField(MaintainStaffDetails md){
        txtIndexNO.setText(new Integer(md.getIndexNO()).toString());
        txtFirstName.setText(md.getFirstName());
        txtLastName.setText(md.getLastName());
        txtNicNO.setText(md.getNICNo());
        txtDOB.setText(md.getDateOfBirth());
        txtage.setText(new Integer(md.getAge()).toString());
        txtConNO.setText(md.getContactNO());
       cmbGender.setSelectedItem(md.getGender());
       txtAddress.setText(md.getAddress());
       txtDiscription.setText(md.getDiscription());
       txtRegNo.setText(md.getRegNo());
       txtMaintainID.setText(md.getMaintainID());
    ...
    private void initComponents() {
        ...
        btnUpdateMaintainStaff = new javax.swing.JButton();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Add Maintain Staff"));
        ...
        btnUpdateMaintainStaff.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        btnUpdateMaintainStaff.setText("Save Change");
        btnUpdateMaintainStaff.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnUpdateMaintainStaffActionPerformed(evt);
            }
        });
        ...
        txtMaintainID.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N

        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel12.setText("maintain ID");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(167, 167, 167)
                        .addComponent(btnUpdateMaintainStaff)
                        .addGap(122, 122, 122)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtIndexNO, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtMaintainID, javax.swing.GroupLayout.PREFERRED_SIZE, 400, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtMaintainID, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel12, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 130, Short.MAX_VALUE)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnUpdateMaintainStaff, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnUpdateMaintainStaffActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateMaintainStaffActionPerformed
            MaintainStaffDetails MD=new MaintainStaffDetails();
            
            MD.setIndexNO(Integer.parseInt(txtIndexNO.getText()));
            MD.setFirstName(txtFirstName.getText());
            MD.setLastName(txtLastName.getText());
            MD.setNICNo(txtNicNO.getText());
            MD.setDateOfBirth(txtDOB.getText());
            MD.setAge(Integer.parseInt(txtage.getText()));
            MD.setContactNO(txtConNO.getText());
            MD.setGender(cmbGender.getSelectedItem().toString());
            MD.setAddress(txtAddress.getText());
            MD.setDiscription(txtDiscription.getText());
            MD.setRegNo(txtRegNo.getText());
            MD.setMaintainID(txtMaintainID.getText());
            System.out.println("button ok");
            boolean result=dbops.UpdateMaintainStaff(MD);
            if(result){
    ...
    }//GEN-LAST:event_btnUpdateMaintainStaffActionPerformed
    ...
    private javax.swing.JButton btnUpdateMaintainStaff;
