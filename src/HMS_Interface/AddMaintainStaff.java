 ...
 * @author acer
 */
public class AddMaintainStaff extends javax.swing.JFrame {
    DBOperation dbops=new DBOperation();

    /**
     * Creates new form AddPatients
     */
    public AddMaintainStaff() {
        initComponents();
    }
    ...
    private void btnEnterDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnterDetailsActionPerformed
        ...
        int x=dbops.checkMaintainstaff(txtNicNO.getText());
        if(x==1){
            JOptionPane.showMessageDialog(this,"this employee already added to the System");
            txtNicNO.setText("");
        }else{
        MS.setIndexNO(0);
        ...
        MS.setDateOfBirth(txtDOB.getText());
        MS.setAge(Integer.parseInt(txtage.getText()));
        MS.setContactNO(txtConNO.getText());
        MS.setGender(cmbGender.getSelectedItem().toString());
        MS.setAddress(txtAddress.getText());
        MS.setDiscription(txtDiscription.getText());
        MS.setRegNo(txtRegNo.getText());
        MS.setMaintainID(txtMaintainID.getText());
        
        
        boolean result=dbops.AddMaintainStaff(MS);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddMaintainStaff.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddMaintainStaff().setVisible(true);
            }
        });
    }
